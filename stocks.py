...
def stock_purchases():
    ...
    dollars_invest = int(input("How much would you like to invest? $"))
    ...
    if stock_name == 'Amazon':
        purchase_power = amazon
    elif stock_name == "Apple":
        purchase_power = apple
    elif stock_name == "FB":
        purchase_power = fb
    elif stock_name == "Google":
        purchase_power = google
    elif stock_name == "Microsoft":
        purchase_power = msft
    
    number_stocks = dollars_invest // purchase_power
    ...
    print(f'{Client_name} has ${dollars_invest} to invest and can buy {number_stocks} of {stock_name} at the current price of ${purchase_power}.')
